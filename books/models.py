...
class Book(models.Model):
    ...
    pages = models.PositiveIntegerField(blank=True, null=True, verbose_name=_('Number of Pages'))
    publication_date = models.DateField(verbose_name=_('Publication Date'))
    publisher = models.CharField(max_length=200, blank=True, null=True, verbose_name=_('Publisher'))
